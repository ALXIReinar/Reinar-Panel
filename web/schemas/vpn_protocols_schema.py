...
class ProtocolCommandUpdateSchema(BaseModel):
    """Схема для обновления команды протокола"""
    cmd_title: str | None = Field(None, min_length=1, max_length=200, description="Название команды")
    command: str | None = Field(None, min_length=1, description="CLI команда для выполнения")
