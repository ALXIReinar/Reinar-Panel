...
from bot.core.utils.keyboards import (
    shop_subs_slider,  # noqa: W291
    user_subs_slider,  # noqa: W291
    ...
    return [
        {
            ...
            'sub_nodes_count': 3,
            'offer_prices': [
                {'offer_id': 1, 'cost': 49900, 'ttl_days': 30, 'traffic_day_limit': 10240,  # noqa: W291
...
# noqa: W293
    with patch.object(CallbackQuery, 'answer', new_callable=AsyncMock):
        with patch.object(Message, 'edit_text', new_callable=AsyncMock) as mock_edit:
            callback = CallbackQuery(id='cb_5', from_user=user, chat_instance='ci', message=message, data=offer_callback)  # noqa: E501
# noqa: W293
...
# noqa: W293
    with patch.object(CallbackQuery, 'answer', new_callable=AsyncMock):
        with patch.object(Message, 'edit_text', new_callable=AsyncMock) as mock_edit:
            callback = CallbackQuery(id='cb_6', from_user=user, chat_instance='ci', message=message, data='subs-shop-pagen_1')  # noqa: E501
# noqa: W293
            # Act
            await callback_factory(callback, redis_client, state, conn)
# noqa: W293
...
# noqa: W293
    with patch.object(CallbackQuery, 'answer', new_callable=AsyncMock):
        with patch.object(Message, 'answer', new_callable=AsyncMock) as mock_message_answer:
            callback = CallbackQuery(id='cb_7', from_user=user, chat_instance='ci', message=message, data='subs-upd-intro')  # noqa: E501
# noqa: W293
            # Act
            await callback_factory(callback, redis_client, state, conn)
# noqa: W293
...
@pytest.mark.asyncio
async def test_user_subs_extend_button_with_real_callback_data(redis_client, mock_template_render, sample_user_subs_data):  # noqa: E501
...
# noqa: W293
    with patch.object(CallbackQuery, 'answer', new_callable=AsyncMock):
        with patch.object(Message, 'edit_text', new_callable=AsyncMock) as mock_edit:
            callback = CallbackQuery(id='cb_9', from_user=user, chat_instance='ci', message=message, data=extend_callback)  # noqa: E501
# noqa: W293
...
@pytest.mark.asyncio
async def test_user_subs_offer_selection_with_real_callback_data(redis_client, mock_template_render, sample_user_subs_data):  # noqa: E501
...
# noqa: W293
    with patch.object(CallbackQuery, 'answer', new_callable=AsyncMock):
        with patch.object(Message, 'edit_text', new_callable=AsyncMock) as mock_edit:
            callback = CallbackQuery(id='cb_10', from_user=user, chat_instance='ci', message=message, data=offer_callback)  # noqa: E501
# noqa: W293
            # Act: эмулируем выбор оффера
            await callback_factory(callback, redis_client, state, conn)
# noqa: W293
...
# noqa: W293
    with patch.object(CallbackQuery, 'answer', new_callable=AsyncMock):
        with patch.object(Message, 'edit_text', new_callable=AsyncMock) as mock_edit:
            callback = CallbackQuery(id='cb_11', from_user=user, chat_instance='ci', message=message, data='subs-user-pagen_1')  # noqa: E501
# noqa: W293
            # Act
            await callback_factory(callback, redis_client, state, conn)
# noqa: W293
...
# noqa: W293
    with patch.object(CallbackQuery, 'answer', new_callable=AsyncMock):
        with patch.object(Message, 'edit_text', new_callable=AsyncMock):
            ...
            callback = CallbackQuery(id='cb_12', from_user=user, chat_instance='ci', message=message, data='subs-shop-offer_1_1')  # noqa: E501
# noqa: W293
            # Act
            await callback_factory(callback, redis_client, state, conn)
# noqa: W293
