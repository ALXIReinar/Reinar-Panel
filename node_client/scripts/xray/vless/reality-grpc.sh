...
[Unit]
Description=Xray Custom Instance VLESS-gRPC-Reality (TMP_ID: ${TMP_ID})
...
echo "Нода $TMP_ID (VLESS-gRPC-Reality) готова. API: $API_PORT, Inbound: $INBOUND_PORT, ServiceName: $SERVICE_NAME"