...
CONFIG_PATH="$CONFIG_DIR/vless-reality-xhttp-${NODE_PROTO_ID}.json"
cat <<EOF > "$CONFIG_PATH"
{
  "log": {
    "loglevel": "warning"
...
[Unit]
Description=Xray Vless Reality Xhttp (NODE_PROTO_ID: ${NODE_PROTO_ID})
