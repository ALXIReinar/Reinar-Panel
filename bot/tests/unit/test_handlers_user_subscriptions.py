...
from bot.core.utils.schemas import UserSubSchema  # noqa: F401
...
# noqa: W293
    with patch.object(Message, 'answer', new_callable=AsyncMock):
        with patch('bot.core.handlers.subscriptions_shop.UserSubscriptions.build_user_subs_slider_msg', new_callable=AsyncMock) as mock_build:  # noqa: E501
            mock_build.return_value = ('Text', MagicMock())
# noqa: W293
            callback = CallbackQuery(id='cb_2', from_user=user, chat_instance='ci', message=message, data='subs-upd-intro')  # noqa: E501
# noqa: W293
            # Act
            await UserSubscriptions.user_subscriptions_slider(callback, redis_client, mock_fsm_context, conn)
# noqa: W293
...
# noqa: W293
    with patch.object(Message, 'answer', new_callable=AsyncMock):
        with patch('bot.core.handlers.subscriptions_shop.UserSubscriptions.build_user_subs_slider_msg', new_callable=AsyncMock) as mock_build:  # noqa: E501
            mock_build.return_value = ('Text', MagicMock())
# noqa: W293
            callback = CallbackQuery(id='cb_3', from_user=user, chat_instance='ci', message=message, data='subs-upd-intro')  # noqa: E501
# noqa: W293
            # Act
            await UserSubscriptions.user_subscriptions_slider(callback, redis_client, mock_fsm_context, conn)
# noqa: W293
...
# noqa: W293
    with patch.object(Message, 'answer', new_callable=AsyncMock):
        with patch('bot.core.handlers.subscriptions_shop.UserSubscriptions.build_user_subs_slider_msg', new_callable=AsyncMock) as mock_build:  # noqa: E501
            mock_build.return_value = ('Text', MagicMock())
# noqa: W293
            callback = CallbackQuery(id='cb_5', from_user=user, chat_instance='ci', message=message, data='subs-upd-intro')  # noqa: E501
# noqa: W293
            # Act
            await UserSubscriptions.user_subscriptions_slider(callback, redis_client, mock_fsm_context, conn)
# noqa: W293
...
# noqa: W293
    ...
    callback = CallbackQuery(id='cb_10', from_user=user, chat_instance='ci', message=message, data='subs-user-pagen_100')  # noqa: E501
# noqa: W293
...
# noqa: W293
    with patch.object(Message, 'answer', new_callable=AsyncMock):
        with patch('bot.core.handlers.subscriptions_shop.UserSubscriptions.user_subscriptions_slider', new_callable=AsyncMock) as mock_slider:  # noqa: E501
            callback = CallbackQuery(id='cb_13', from_user=user, chat_instance='ci', message=message, data='subs-user-upd_0')  # noqa: E501
# noqa: W293
            # Act
...
# noqa: W293
    ...
    callback = CallbackQuery(id='cb_14', from_user=user, chat_instance='ci', message=message, data='subs-user-offer_0_0')  # noqa: E501
# noqa: W293
    # Act
...
# noqa: W293
    ...
    callback = CallbackQuery(id='cb_15', from_user=user, chat_instance='ci', message=message, data='subs-user-offer_0_0')  # noqa: E501
# noqa: W293
    # Act
...
@pytest.mark.asyncio
@patch.object(CallbackQuery, 'answer', new_callable=AsyncMock)
async def test_give_issued_payment_api_error(mock_callback_answer, mock_fsm_context, sample_user_subs_data, redis_client):  # noqa: E501
...
# noqa: W293
    ...
    callback = CallbackQuery(id='cb_16', from_user=user, chat_instance='ci', message=message, data='subs-user-offer_0_0')  # noqa: E501
# noqa: W293
    # Act
    text, kb = await UserSubscriptions.give_issued_payment(callback, redis_client, mock_fsm_context, conn, 0, 0)
# noqa: W293
...
# noqa: W293
    with patch.object(Message, 'answer', new_callable=AsyncMock):
        with patch('bot.core.handlers.subscriptions_shop.UserSubscriptions.user_subscriptions_slider', new_callable=AsyncMock) as mock_slider:  # noqa: E501
            callback = CallbackQuery(id='cb_17', from_user=user, chat_instance='ci', message=message, data='subs-user-offer_0_0')  # noqa: E501
# noqa: W293
            # Act
