...
def upgrade() -> None:
    ...
    op.alter_column('templates_users_extractors', 'extractor_script', existing_type=sa.Text(), nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column('templates_users_extractors', 'extractor_script', existing_type=sa.Text(), nullable=True)
