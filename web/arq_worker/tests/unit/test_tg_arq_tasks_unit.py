...
class TestSendSubLinkTgUser:
    ...
    async def test_send_sub_link_success(self, mock_arq_ctx, db_pool, tg_routing_seed, mock_aiohttp_success):
        ...
        # Act
        result = await send_sub_link_tg_user(mock_arq_ctx, user_id, user_sub_id)
        # Assert
    ...
    async def test_send_sub_link_formats_message_correctly(
        self, mock_arq_ctx, db_pool, tg_routing_seed, mock_aiohttp_success
    ):
        """
