...
CONFIG_PATH="$CONFIG_DIR/hy2-tls-hopping-${NODE_PROTO_ID}.json" # конфиги не должны совпасть
...
[Unit]
Description=Sing-box Hysteria2 Hopping Node (NODE_PROTO_ID: ${NODE_PROTO_ID})
